...
export default function ContactForm() {
    ...
    return (
        <div className="flex flex-col p-8 border-4 border-white min-h-screen bg-stone-600">
            <div className="min-h-screen flex flex-col justify-center items-center px-4">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                id="firstName"
                                name="firstName"
                                className="w-full p-2 bg-zinc-950 opacity-50 border-black rounded"
                        ...
                        <button type="submit" className="bg-zinc-950 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded">
                            Send
                        </button>
                    </form>
                ...
                <div className="mt-8">
                    <Link href="/" className="bg-zinc-950 hover:bg-zinc-700 text-white font-bold py-2 px-4 rounded">
                        Back to Home Page
                    </Link>
                </div>
            </div>
